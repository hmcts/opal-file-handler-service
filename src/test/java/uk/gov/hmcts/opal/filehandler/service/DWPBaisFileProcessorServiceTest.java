...
public class DWPBaisFileProcessorServiceTest {
    private static final String FILE_NAME = "0000000000_dat_0000000000_11111111_222222.txt";
    ...
    @BeforeEach
    void setUp() {
        service = new DWPBaisFileProcessorService(
            Clock.systemUTC(),
            featureFlagUtil,
            baisSftpClient,
            blobStoreService,
