...
@SpringBootTest(properties = {
    "opal.automated-task=DWPFileTransferJob",
    "spring.main.web-application-type=none"
})
public class AutomatedTaskDWPFileTransferIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldCallAutomatedTaskRun() {
        verify(service, times(1)).run(any(DWPBaisFileProcessorConfiguration.class));
    }
